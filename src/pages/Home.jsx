...
function Home() {
  return (
    <div className="Home">
      {/* <!-- Header Area --> */}
      <header id="header" class="w-100 biker-header-bg pb-3">
        {/* <!-- Navigation Bar --> */}
        <div>
          <nav class="navbar navbar-expand-md bg-transparent">
            <div class="container">
              ...
              <div
                class="collapse navbar-collapse text-end mt-3"
        ...
        {/* <!-- Banner --> */}
        <div class="container">
          <div class="row row-cols-1 row-cols-lg-2 d-flex flex-lg-row flex-column-reverse gx-3 gy-4 mt-lg-5">
            <div class="col d-flex justify-content-center align-items-center">
              <div>
                ...
                <h1 class="fw-bold display-4 text-white">Honda CBR 300R</h1>
                <p class="text-white">
            ...
            <div class="col d-flex justify-content-center align-items-center">
              <div class="text-end">
                <img
                  class="w-100"
                  src=".//assets/images/header-bike.png"
                  alt="Header Bike"
                />
              </div>
            </div>
          ...
          <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 gy-5 py-5 text-center">
            <div class="col">
              <img
                ...
                src="/assets/images/feature-bike.jpg"
                alt=""
              />
            </div>
            <div class="col">
